#Created BY: Alok Ahuja, Abhishek Goklani, YashVardhan Singh Tomar, Aryan Dhakkad


# 19th MAY 2020


#Resturant Bill generator using python and tkinter GUI library



 
#To import GUI to the python
from tkinter import*
import random
import time
import datetime

#To define window title and size
...
lblInfo=Label(Tops,font=('helvetica',50,'bold'),text="THE CENTRAL PERK ",fg="Black",bd=10,anchor='w')
lblInfo.grid(row=0,column=0)

lblInfo=Label(Tops,font=('arial',20,'bold'),text=localtime,fg="Steel Blue",bd=10,anchor='w')
lblInfo.grid(row=1,column=0)

#Function to define various inputs to the program

#To add reference number to the bill
...
#To define exit button
    
def qExit():
    root.destroy()

#To define reset button
